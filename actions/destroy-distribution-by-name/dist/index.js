...
const node_fetch_1 = __importDefault(__nccwpck_require__(5597));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const apiToken = core.getInput('api-token');
            const appOwnerName = core.getInput('app-owner-name');
            const platform = core.getInput('platform').toLowerCase();
            const appId = core.getInput('app-id');
            const distributionName = core.getInput('distribution-name');
            const isTestMode = core.getInput('test') === 'true';
            ...
            if (isTestMode) {
                ...
                const response = yield (0, node_fetch_1.default)(`https://deploygate.com/api/users/${appOwnerName}/platforms/${platform}/apps/${appId}/distributions/`, {
                    headers: {
                        Authorization: `token ${apiToken}`
                    },
                    body: JSON.stringify({ distribution_name: distributionName }),
...
const os = __importStar(__nccwpck_require__(2037));
const uuid_1 = __nccwpck_require__(1896);
const utils_1 = __nccwpck_require__(798);
...
var _v = _interopRequireDefault(__nccwpck_require__(9800));

var _v2 = _interopRequireDefault(__nccwpck_require__(196));

var _v3 = _interopRequireDefault(__nccwpck_require__(4622));

var _v4 = _interopRequireDefault(__nccwpck_require__(9324));

var _nil = _interopRequireDefault(__nccwpck_require__(1717));

var _version = _interopRequireDefault(__nccwpck_require__(7132));

var _validate = _interopRequireDefault(__nccwpck_require__(3123));

var _stringify = _interopRequireDefault(__nccwpck_require__(4217));

var _parse = _interopRequireDefault(__nccwpck_require__(8391));
...
var _rng = _interopRequireDefault(__nccwpck_require__(2637));
...
var _md = _interopRequireDefault(__nccwpck_require__(4828));
...
var _sha = _interopRequireDefault(__nccwpck_require__(2256));
...
var _regex = _interopRequireDefault(__nccwpck_require__(3855));
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(4548);
