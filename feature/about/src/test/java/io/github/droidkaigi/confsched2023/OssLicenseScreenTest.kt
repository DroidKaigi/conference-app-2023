...
import io.github.droidkaigi.confsched2023.testing.robot.OssLicenseScreenRobot
...
class OssLicenseScreenTest {
    ...
    fun checkLaunchShot() {
        ossLicenseScreenRobot {
            setupOssLicenseScreenContent()
            checkScreenCapture()
        }
    }
}
